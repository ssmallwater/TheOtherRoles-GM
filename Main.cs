...
{
    [BepInPlugin(Id, "超多职业3.5.2 GM", VersionString)]
    ...
    public class TheOtherRolesPlugin : BasePlugin
    {
        ...
        public override void Load()
        {
            ...
            GhostsSeeTasks = Config.Bind("Custom", "鬼魂可见剩余任务", true);
            GhostsSeeRoles = Config.Bind("Custom", "鬼魂可见职业", true);
            GhostsSeeVotes = Config.Bind("Custom", "鬼魂可见投票", true);
            ShowRoleSummary = Config.Bind("Custom", "展示职业介绍", true);
            HideNameplates = Config.Bind("Custom", "隐藏名牌", false);
            ShowLighterDarker = Config.Bind("Custom", "展示浅色或深色", false);
